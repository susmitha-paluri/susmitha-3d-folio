...
export const AboutSection = () => {
  ...
  return <section id="about" className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <ScrollReveal>
          <div className="bg-card border border-border rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 card-3d neon-glow">
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-3xl lg:max-w-4xl max-h-[85vh] overflow-y-auto bg-card/95 backdrop-blur-sm border-border">
          <DialogHeader>
            <DialogTitle className="text-2xl sm:text-3xl gradient-text">More About Paluri Susmitha</DialogTitle>
          ...
          <div className="space-y-6 mt-6">
            <div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 text-primary">My Journey</h3>
            ...
            <div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 text-primary">Goals & Vision</h3>
              <p className="text-foreground leading-relaxed">
            ...
            <div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 text-primary">Key Achievements</h3>
            ...
            <div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 text-primary">Interests</h3>
              <p className="text-foreground leading-relaxed">
