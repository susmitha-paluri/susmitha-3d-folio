    ...
    icon: function GeeksForGeeks() {
      return (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          <path d="M3.5 8.5L6 11 3.5 13.5 2 12l1.5-1.5L2 9l1.5-1.5zm4.5 7h2v1h-2v-1zm9-7L19.5 11 17 13.5 18.5 15l1.5-1.5L21.5 15l-1.5 1.5L17 13.5 19.5 11 17 8.5 18.5 7l1.5 1.5L21.5 7l-1.5-1.5zM12 3C7.03 3 3 7.03 3 12s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7z"/>
        </svg>
      );
    },
